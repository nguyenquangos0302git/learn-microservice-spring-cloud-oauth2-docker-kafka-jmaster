...
@FeignClient(name = "notification-service", url = "http://localhost:9083", fallback = NotificationServiceImpl.class, configuration = NotificationFeignClientConfig.class)
